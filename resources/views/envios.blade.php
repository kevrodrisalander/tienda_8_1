                        ...
                        <table class="table_id" id="tbl_provedores">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Id Provedor</th>
                                    <th class="text-center">Proveedor</th>
                                    <th class="text-center">Nombre del repartidor</th>
                                    <th class="text-center">Telefono celular</th>
                                    <th class="text-center">Tipo de transporte</th>
                                    <th class="text-center">Matricula</th>
                                    {{-- <th class="text-center">Email</th> --}}
                                    <th class="text-center">Fecha del requerimiento</th>
