...
@section('content')
    <div class="container">
        ...
        <div class="py-4 text-center bg-light rounded mb-4">
            <h1 class="fw-bold">Ropa</h1>
            <p class="text-muted">Viste con estilo en nuestro Departamento de Ropa: moda para toda la familia, desde lo
                casual hasta lo elegante, con las últimas tendencias y grandes ofertas.</p>
        </div>
