...
@section('content')
    <div class="container">
        ...
        <div class="py-4 text-center bg-light rounded mb-4">
            <h1 class="fw-bold">Electrónica vivirás la innovación.</h1>
            <p class="text-muted">Sistemas de sonido envolvente, laptops y dispositivos inteligentes que transforman tu
                día a día.
                Calidad, variedad y servicio al alcance de tu mano.</p>
        </div>
